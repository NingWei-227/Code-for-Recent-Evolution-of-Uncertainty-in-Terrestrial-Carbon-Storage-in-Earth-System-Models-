% Figure1: evaluating model spread and model bias in the near-present land carbon storage for CMIP5 and CMIP6 model ensembles
% models: cLand = cVeg+cLitter+cSOM 
% Observational data include:  cVeg  from Spawn et al., 2020;
%                                      cSoil from HWSD LandGIS SoilGrids and NCSCD
%                                      (0-100cm cSoil was used as in the benchmark analysis)                            
% observational datasets were regrided into 0.5x0.5 resolution
% units were unified as Kg C m-2
clear;clc;

%% CMIP5 data: veg and  soil carbon(accounting for cLitter and cSoil)
...
% calculate cSoil for each CMIP5 model
% note that GFDL and HadGEM2 did not represent cLitter
...
% calculate cSoil for each CMIP6 model
% UKESM1-0-LL did not represent cLitter
...
%% calculating the near-present cLand (2001-2005 mean) for CMIP5 and CMIP6
% cLand (combining cVeg and cSoil) from 2001 to 2005 
% unit:KgC m-2
% CMIP5
...
% load Global terrestrial C storage in CMIP5 and CMIP6
...
%% load processed observational data
% observation-derived data
load('E:\1_Mycase\3_CMIP56_Cland\2_Benchmark\1_obsData\cLand\Biomass\ORNL\Global_Maps_C_Density_2010_1763\cVeg05_KgCm2.mat')                  % cVeg from Spawn et al., 2020;
load('E:\1_Mycase\3_CMIP56_Cland\2_Benchmark\1_obsData\cLand\SoilC\HWSD\HWSD_1247\HWSDv2_05.mat')                                             % HWSD                     
load('E:\1_Mycase\3_CMIP56_Cland\2_Benchmark\1_obsData\cLand\SoilC\LandGIS\LandGIS05_1m.mat')                                                 % LandGIS
load('E:\1_Mycase\3_CMIP56_Cland\2_Benchmark\1_obsData\cLand\SoilC\SoilGrids\SoilGrid05_1mkg.mat')                                            % SoilGrids                        
load('E:\1_Mycase\3_CMIP56_Cland\2_Benchmark\1_obsData\cLand\SoilC\Circumpolar_cSoil\NCSCDv2_Circumpolar_netCDF_05deg\NCSCD05_1mkg.mat')      % NCSCD
% merge observational cSoil data  
...
% For consistency(both simulations and observations), deserts and other regions where GPP<0.01 kgC m-2 yr-1 were omitted based on the criteria of Fan et al., 2019
% load Observational dataset from Fan et al., 2019 and creat mask E 
tuaE_map_obs = ncread('E:\1_Mycase\3_CMIP56_Cland\2_Benchmark\1_obsData\tuaE\tau_all.nc','tau');
tuaE_median1m_obs = tuaE_map_obs(:,:,1)';  
...
% color code used for each model    
...
%% Figure1: panel(a) and (d), spatial patterns of model spread in cland
% estimate across-model variation and omit extremely large values
...
% inserted panels for global terrestrial carbon simulated from each model
...
set(gca,'Fontname','Arial','FontSize',10)
set(gca,'YTickLabelMode','auto');
ylabel('PgC','Fontname','Arial','FontSize',11)
set(gca,'color','none','TickDir','out','TickLength',[0.03 0.035])
...
%% Figure1: panel(b) and (e), spatial patterns of model bias in cland
% calculate model ensemble mean of cLand
...
% inserted panels for model bias at the global scale   
...
%% Figure1: panel(c) and (f), Zonal mean plots for CMIP5 and CMIP6
