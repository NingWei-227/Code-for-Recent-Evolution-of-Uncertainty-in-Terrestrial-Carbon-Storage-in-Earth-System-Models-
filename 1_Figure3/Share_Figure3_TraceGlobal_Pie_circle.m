...
% NPP_2X = 0.47; tuaE_2X = 0.45; Xp_2X =0.08;
% contributions of GPP and CUE to NPP
% GPP_2NPP = 0.68; CUE_2NPP = 0.32 
...
% CMIP6: 
% constributions of NPP, tuaE, and Xp to X
% NPP_2X = 0.21; tuaE_2X = 0.67; Xp_2X =0.12;
% contributions of GPP and CUE to NPP
% GPP_2NPP = 0.5; CUE_2NPP = 0.5 
% contributions of tuaE_base, tuaE_scalar_tem, tuaE_scalar_pre to tuaE
% tuaE_base = 0.97
% tuaE_scalar_tem = 0.2
% tuaE_scalar_pre = 0.01 
...
text(0,-2.8,'Xp','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',12,...
        'BackgroundColor',[1 1 1],'Margin',1)
    text(0,-3.6,'0.08','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',11,...
        'Margin',1,'Rotation',-5,'color',[0.89,0.02 0.02])    
    
text(3.*cos(19/180*pi),-3.*sin(19/180*pi),'\tau_E','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',12,...
        'BackgroundColor',[1 1 1],'Margin',1,'Rotation',78)   
    text(2.5087,0.1944,'0.45','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',11,...
...
text(-3.*cos(19/180*pi),-3.*sin(19/180*pi),'NPP','HorizontalAlignment','center',...
    ...
    text(-2.55,0.4072,'0.47','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',12,...
        'Margin',1,'Rotation',-75,'color',[1,0,0],'FontWeight','bold') 
...
text(0,-2.8,'Xp','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',12,...
        'BackgroundColor',[1 1 1],'Margin',1)
       text(0,-3.6,'0.12','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',11,...
        'Margin',1,'Rotation',-5,'color',[0.89,0.02 0.02]) 
...
text(2.9.*cos(19/180*pi),-2.9.*sin(19/180*pi),'\tau_E','HorizontalAlignment','center',...
    ...
    text(2.5087,0.1944,'0.67','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',12,...
...
text(-2.9.*cos(19/180*pi),-2.9.*sin(19/180*pi),'NPP','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',12,...
        'BackgroundColor',[1 1 1],'Margin',2,'Rotation',-74) 
    text(-2.55,0.4072,'0.21','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',11,...
...
text(5.*cos(19/180*pi),-5.*sin(19/180*pi),'\tau_E','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',12,...
        'BackgroundColor',[1 1 1],'Margin',1,'Rotation',74)
    text(5.41,-0.545,'0.97','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',12,...
        'Margin',1,'Rotation',78,'color',[1,0,0],'FontWeight','bold')
 ...
 text(5.*cos(69/180*pi),-5.*sin(69/180*pi),'\xi_T','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',13,...
        'BackgroundColor',[1 1 1],'Margin',2,'Rotation',10)
    text(2.7033,-5.202,'0.02','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',11,...
       'Margin',2,'Rotation',30,'color',[0.89,0.02 0.02])   
axis([-5 5 -5 5])
...
tuaE_base = 0.45*0.98
tuaE_scalar_tem = 0.45*0.01
tuaE_scalar_pre = 0.45*0.01 

axes(pies_panel(1))
CMIP5_bg = [GPP CUE Xp tuaE_base tuaE_scalar_tem tuaE_scalar_pre]
labels = {'GPP' 'CUE' 'Xp' '\tau_E' '\xi_T' '\xi_w'}
...
tuaE_base = 0.67*0.97
tuaE_scalar_tem = 0.67*0.02
tuaE_scalar_pre = 0.67*0.01

CMIP6_bg = [GPP CUE Xp tuaE_base tuaE_scalar_tem tuaE_scalar_pre]
labels = {'GPP' 'CUE' 'Xp' '\tau_E' '\xi_T' '\xi_w'}
